...
3. **按需加载** 对应子模板
4. **交叉参考** `O_boundary.md` 防止误标 SPECIAL 标签（实际是 BIZ / AUX / LINK / UI / HINT / LOG / CONFIG）
