...
> **TP 库位置**：`knowledge/public/test_point_library/SPECIAL/`
> **子模板来源**：`knowledge/public/module_templates/SPECIAL/`
...
## UTIL vs BIZ vs LINK vs SPECIAL 核心区分（**"水管 vs 业务 vs 互通 vs 对抗"**）
