...
> **TP 库位置**：`knowledge/public/test_point_library/LOG/`
> **子模板来源**：`knowledge/public/module_templates/LOG/`
...
> **判定口诀**：（1）测"业务侧应该写什么日志、写什么字段、字段怎么脱敏、链路怎么串联" → **LOG**；（2）测"S SDK 怎么采集、文件怎么写、网络怎么传" → **UTIL**。
