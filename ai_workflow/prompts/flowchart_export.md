...
> 输出：`workflow_assets/<req_name>/「S4 流程图导出」/<version>/business_flow.md`（1 个文件）
...
参见 `workflow_assets/游戏道具商城系统/「S4 流程图导出」/v1.0/business_flow.md`（含 11 Epic × 4 类产出 + 18 风险点 + 异常树叶子节点 + 风险点汇总表）。
