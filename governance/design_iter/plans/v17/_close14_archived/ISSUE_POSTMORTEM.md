...
| **I-06** | s6_report.py 和 check_field_completion.py 仍延后 | LOW | 已在 2_5_l1_scripts_rewrite.md 标记为 v17.1 增量，本轮不修 | ai_workflow/s6_report.py + scripts/check_field_completion.py |
