...
> **测试点模板**（`workflow_assets/module_templates/*.md`）中提到的"模块"必须与本文件保持一致。
>
...
> **明细、场景、种子 TP、验证证据** 全部在 `workflow_assets/module_templates/UI/` 下，
> 本节不再重复（避免双写漂移）。
>
...
| 字母 | 子类       | 测试类型枚举                                     | 模板                                                                |
| ---- | ---------- | ------------------------------------------------ | ------------------------------------------------------------------- |
| A    | 控件基础   | `CONTROL_RENDER` / `CONTROL_STATE` / `CONTROL_BASE_FUNC` / `CONTROL_BOUNDARY` | [`A_control_basic.md`](../workflow_assets/module_templates/UI/A_control_basic.md)     |
| B    | 纯前端交互 | `PURE_INTERACTION`                               | [`B_pure_interaction.md`](../workflow_assets/module_templates/UI/B_pure_interaction.md) |
| C    | 布局适配   | `LAYOUT_ADAPT`                                   | [`C_layout_adapt.md`](../workflow_assets/module_templates/UI/C_layout_adapt.md)         |
| D    | 静态展示   | `STATIC_DISPLAY`                                 | [`D_static_display.md`](../workflow_assets/module_templates/UI/D_static_display.md)     |
| E    | 动效动画   | `ANIMATION`                                      | [`E_animation.md`](../workflow_assets/module_templates/UI/E_animation.md)               |
| F    | 引导浮窗   | `GUIDE_HINT`                                     | [`F_guide_hint.md`](../workflow_assets/module_templates/UI/F_guide_hint.md)             |
| G    | 无障碍     | `ACCESSIBILITY`                                  | [`G_accessibility.md`](../workflow_assets/module_templates/UI/G_accessibility.md)       |
| H    | 异常场景   | `EDGE_UI`                                        | [`H_edge_ui.md`](../workflow_assets/module_templates/UI/H_edge_ui.md)                   |
| I    | 边界区分   | —（判定规则，非测试类型）                        | [`I_boundary.md`](../workflow_assets/module_templates/UI/I_boundary.md)                 |
| J    | 游戏专项   | —（游戏项目专属，非通用测试类型）                | [`J_game_specific.md`](../workflow_assets/module_templates/UI/J_game_specific.md)       |
...
> **明细、场景、种子 TP、验证证据** 全部在 `workflow_assets/module_templates/CONFIG/` 下，本节不重复。

### 概览（11 大类）

| 字母 | 子类       | 测试类型枚举（v1.2）                          | 模板                                                                |
| ---- | ---------- | --------------------------------------------- | ------------------------------------------------------------------- |
| A    | 字段合法性 | `FIELD_LEGALITY`                              | [`A_field_legality.md`](../workflow_assets/module_templates/CONFIG/A_field_legality.md)  |
| B    | 同表一致性 | `FIELD_INTRA_DEP`                             | [`B_consistency.md`](../workflow_assets/module_templates/CONFIG/B_consistency.md)       |
| C    | 跨表依赖   | `FIELD_CROSS_DEP`                             | [`C_cross_dep.md`](../workflow_assets/module_templates/CONFIG/C_cross_dep.md)            |
| D    | 热更新     | `RELOAD_4_MODE`                               | [`D_hot_reload.md`](../workflow_assets/module_templates/CONFIG/D_hot_reload.md)         |
| E    | 解析加载   | `PARSE_LOAD`                                  | [`E_parse_load.md`](../workflow_assets/module_templates/CONFIG/E_parse_load.md)         |
| F    | 版本兼容   | `VERSION_COMPAT`                              | [`F_version_compat.md`](../workflow_assets/module_templates/CONFIG/F_version_compat.md) |
| G    | 数值逻辑   | `VALUE_LOGIC`                                 | [`G_value_logic.md`](../workflow_assets/module_templates/CONFIG/G_value_logic.md)       |
| H    | 导出发布   | `EXPORT_PUBLISH`                              | [`H_export_publish.md`](../workflow_assets/module_templates/CONFIG/H_export_publish.md) |
| I    | 服务端专属 | `SERVER_CONFIG`                               | [`I_server_specific.md`](../workflow_assets/module_templates/CONFIG/I_server_specific.md) |
| J    | 边界区分   | —（判定规则，非测试类型）                    | [`J_boundary.md`](../workflow_assets/module_templates/CONFIG/J_boundary.md)             |
| K    | 游戏专项   | —（游戏项目专属，非通用测试类型）            | [`K_game_specific.md`](../workflow_assets/module_templates/CONFIG/K_game_specific.md)   |
...
> ⚠️ **完整边界规则 + 误判案例 + 决策树** 见 [`CONFIG/J_boundary.md`](../workflow_assets/module_templates/CONFIG/J_boundary.md)。
...
> ⚠️ **完整边界规则 + 误判案例 + 决策树** 见 [`UI/I_boundary.md`](../workflow_assets/module_templates/UI/I_boundary.md)。
...
### 枚举值与子类映射（11 个 v1.2 枚举）

| 枚举值              | 归属子类       | 模板                                                                |
| ------------------- | -------------- | ------------------------------------------------------------------- |
| `CONTROL_RENDER`    | A.控件基础     | [`A_control_basic.md`](../workflow_assets/module_templates/UI/A_control_basic.md)   |
| `CONTROL_STATE`     | A.控件基础     | [`A_control_basic.md`](../workflow_assets/module_templates/UI/A_control_basic.md)   |
| `CONTROL_BASE_FUNC` | A.控件基础     | [`A_control_basic.md`](../workflow_assets/module_templates/UI/A_control_basic.md)   |
| `CONTROL_BOUNDARY`  | A.控件基础     | [`A_control_basic.md`](../workflow_assets/module_templates/UI/A_control_basic.md)   |
| `PURE_INTERACTION`  | B.纯前端交互   | [`B_pure_interaction.md`](../workflow_assets/module_templates/UI/B_pure_interaction.md) |
| `LAYOUT_ADAPT`      | C.布局适配     | [`C_layout_adapt.md`](../workflow_assets/module_templates/UI/C_layout_adapt.md)     |
| `STATIC_DISPLAY`    | D.静态展示     | [`D_static_display.md`](../workflow_assets/module_templates/UI/D_static_display.md) |
| `ANIMATION`         | E.动效动画     | [`E_animation.md`](../workflow_assets/module_templates/UI/E_animation.md)           |
| `GUIDE_HINT`        | F.引导浮窗     | [`F_guide_hint.md`](../workflow_assets/module_templates/UI/F_guide_hint.md)         |
| `ACCESSIBILITY`     | G.无障碍       | [`G_accessibility.md`](../workflow_assets/module_templates/UI/G_accessibility.md)   |
| `EDGE_UI`           | H.异常场景     | [`H_edge_ui.md`](../workflow_assets/module_templates/UI/H_edge_ui.md)               |
...
> **明细、场景、种子 TP、验证证据** 全部在 `workflow_assets/module_templates/AUX/` 下，本节不重复。

### 概览（16 大类）

| 字母 | 子类          | 测试类型枚举（v1.2）                | 模板                                                                |
| ---- | ------------- | ----------------------------------- | ------------------------------------------------------------------- |
| A    | 公共工具      | `COMMON_UTIL`                       | [`A_common_util.md`](../workflow_assets/module_templates/AUX/A_common_util.md)        |
| B    | 网络层        | `NETWORK_LAYER`                     | [`B_network_layer.md`](../workflow_assets/module_templates/AUX/B_network_layer.md)    |
| C    | 缓存层        | `CACHE_HIT_RATE`                    | [`C_cache_layer.md`](../workflow_assets/module_templates/AUX/C_cache_layer.md)        |
| D    | 资源管理      | `RESOURCE_MGMT`                     | [`D_resource_mgmt.md`](../workflow_assets/module_templates/AUX/D_resource_mgmt.md)    |
| E    | 汇率换算      | `CURRENCY_EXCHANGE`                 | [`E_currency_exchange.md`](../workflow_assets/module_templates/AUX/E_currency_exchange.md) |
| F    | 离线/版本更新 | `OFFLINE_UPDATE`                    | [`F_offline_update.md`](../workflow_assets/module_templates/AUX/F_offline_update.md)  |
| G    | GM 工具       | `GM_TOOL`                           | [`G_gm_tool.md`](../workflow_assets/module_templates/AUX/G_gm_tool.md)                |
| H    | 测试脚本      | `TEST_SCRIPT`                       | [`H_test_script.md`](../workflow_assets/module_templates/AUX/H_test_script.md)        |
| I    | 策划验收      | `ACCEPTANCE_CHECKLIST`              | [`I_acceptance_checklist.md`](../workflow_assets/module_templates/AUX/I_acceptance_checklist.md) |
| J    | 存储         | `LOCAL_STORAGE`（v1.6.1 重命名 + 收窄为本地存档）  | [`J_storage.md`](../workflow_assets/module_templates/AUX/J_storage.md)                  |
| K    | 画质/性能     | `PERF_TOOL`                         | [`K_perf_tool.md`](../workflow_assets/module_templates/AUX/K_perf_tool.md)            |
| L    | 运营辅助      | `OPS_TOOL`                          | [`L_ops_tool.md`](../workflow_assets/module_templates/AUX/L_ops_tool.md)              |
| M    | 加密安全      | `SECURITY`                          | [`M_security.md`](../workflow_assets/module_templates/AUX/M_security.md)              |
| N    | 异常兜底      | `ERROR_RECOVERY`                    | [`N_error_recovery.md`](../workflow_assets/module_templates/AUX/N_error_recovery.md)  |
| O    | 边界区分      | —（判定规则，非测试类型）          | [`O_boundary.md`](../workflow_assets/module_templates/AUX/O_boundary.md)              |
| P    | 游戏项目补充  | —（游戏项目专属，非通用测试类型）  | [`P_game_specific.md`](../workflow_assets/module_templates/AUX/P_game_specific.md)    |
...
> ⚠️ **完整边界规则 + 误判案例 + 决策树** 见 [`AUX/O_boundary.md`](../workflow_assets/module_templates/AUX/O_boundary.md)。
...
> **明细、场景、种子 TP、验证证据** 全部在 `workflow_assets/module_templates/BIZ/` 下，本节不重复。

### 概览（11 文件 = 9 测试子模板 + 2 规则）

| 字母 | 子类 | 测试类型枚举（v1.2） | 模板 |
| ---- | ---- | ------------------- | ---- |
| A    | 核心业务逻辑   | `BIZ_LOGIC`         | [`A_biz_logic.md`](../workflow_assets/module_templates/BIZ/A_biz_logic.md) |
| B    | 端服数据流     | `BIZ_DATA_FLOW`     | [`B_data_flow.md`](../workflow_assets/module_templates/BIZ/B_data_flow.md) |
| C    | 协议交互       | `BIZ_PROTOCOL`      | [`C_protocol.md`](../workflow_assets/module_templates/BIZ/C_protocol.md) |
| D    | 状态机         | `BIZ_STATE_MACHINE` | [`D_state_machine.md`](../workflow_assets/module_templates/BIZ/D_state_machine.md) |
| E    | 数据库持久化   | `BIZ_DB_PERSIST`    | [`E_db_persist.md`](../workflow_assets/module_templates/BIZ/E_db_persist.md) |
| F    | 并发/多玩家    | `BIZ_CONCURRENCY`   | [`F_concurrency.md`](../workflow_assets/module_templates/BIZ/F_concurrency.md) |
| G    | 定时&异步任务  | `BIZ_SCHEDULED_TASK`| [`G_scheduled_task.md`](../workflow_assets/module_templates/BIZ/G_scheduled_task.md) |
| H    | 付费&商业化    | `BIZ_PAYMENT`       | [`H_payment.md`](../workflow_assets/module_templates/BIZ/H_payment.md) |
| I    | 日志与审计     | `BIZ_AUDIT_LOG`     | [`I_audit_log.md`](../workflow_assets/module_templates/BIZ/I_audit_log.md) |
| O    | 边界区分       | —（判定规则，非测试类型）| [`O_boundary.md`](../workflow_assets/module_templates/BIZ/O_boundary.md) |
| P    | 游戏项目补充   | —（游戏项目专属）| [`P_game_specific.md`](../workflow_assets/module_templates/BIZ/P_game_specific.md) |
...
> ⚠️ **完整边界规则 + 误判案例 + 决策树** 见 [`BIZ/O_boundary.md`](../workflow_assets/module_templates/BIZ/O_boundary.md)。
...
> **明细、场景、种子 TP、验证证据** 在 [`workflow_assets/module_templates/LINK/`](../workflow_assets/module_templates/LINK.md) 下（**v1.8 已建** 1 概览 + 6 子模板 + O 边界 + P 游戏专项 = 8 文件），本节不重复（避免双写漂移）。
>
...
> ⚠️ **完整边界规则 + 误判案例 + 决策树** 见 [`LINK/O_boundary.md`](../workflow_assets/module_templates/LINK/O_boundary.md)（**v1.8 已建**——含 7 大类边界对照 + 7 个误判案例 + 判定流程图 + 6 子类判定口诀）。
...
- 改 §4.9 边界规则**必须**同步改 [`LINK/O_boundary.md`](../workflow_assets/module_templates/LINK/O_boundary.md)（v1.8 已建，含 7 大类边界对照 + 7 个误判案例 + 判定流程图 + 6 子类判定口诀）
...
> **明细、场景、种子 TP、验证证据** 全部在 `workflow_assets/module_templates/SPECIAL/` 下，本节不重复（避免双写漂移）。
>
...
> ⚠️ **完整边界规则 + 误判案例 + 决策树** 见 [`SPECIAL/O_boundary.md`](../workflow_assets/module_templates/SPECIAL/O_boundary.md)。
...
| 枚举值 | 归属子类 | 模板 | 备注 |
| --- | --- | --- | --- |
| `BOUNDARY_EXTREME` | A.边界极端场景 | [A_boundary_extreme.md](../workflow_assets/module_templates/SPECIAL/A_boundary_extreme.md) | 数值/时间/权限/中断/冲突 5 类边界 |
| `ANTI_CHEAT` | B.反作弊 / 数据安全 | [B_anti_cheat.md](../workflow_assets/module_templates/SPECIAL/B_anti_cheat.md) | 含 v1.1 旧 `ANTI_CHEAT` 扩展（行为反作弊+数据安全+参数篡改）|
| `WEAK_NET_RATE_LIMIT` | C.弱网 / 限流 | [C_weak_net_rate_limit.md](../workflow_assets/module_templates/SPECIAL/C_weak_net_rate_limit.md) | 含 v1.1 旧 `WEAK_NETWORK` 升级（语义扩展为"网络异常+流量限流"）|
| `BG_FG_SWITCH` | D.前后台切换 | [D_bg_fg_switch.md](../workflow_assets/module_templates/SPECIAL/D_bg_fg_switch.md) | 含 v1.1 旧 `SWITCH_TO_BACKGROUND` 升级（生命周期恢复）|
| `SERVER_HA_RISK` | E.宕机/并发/高危 | [E_server_ha_risk.md](../workflow_assets/module_templates/SPECIAL/E_server_ha_risk.md) | v1.11 新增（覆盖原 v1.1 缺失的"服务 HA + 万人并发 + 高危风控"）|
| `VERSION_COMPAT_BIZ` | F.版本兼容 | [F_version_compat_biz.md](../workflow_assets/module_templates/SPECIAL/F_version_compat_biz.md) | v1.11 新增（原 v1.1 完全缺失）|
| `CHANNEL_GRAY_BIZ` | G.渠道/灰度 | [G_channel_gray_biz.md](../workflow_assets/module_templates/SPECIAL/G_channel_gray_biz.md) | v1.11 新增（原 v1.1 完全缺失）|
| `COMPLIANCE_RISK` | H.合规风控 | [H_compliance_risk.md](../workflow_assets/module_templates/SPECIAL/H_compliance_risk.md) | v1.11 新增（原 v1.1 完全缺失）|
| `RESOURCE_EXHAUST` | I.资源耗尽 | [I_resource_exhaust.md](../workflow_assets/module_templates/SPECIAL/I_resource_exhaust.md) | v1.11 新增（原 v1.1 完全缺失）|
...
> **明细、场景、种子 TP、验证证据** 全部在 [`workflow_assets/module_templates/HINT/`](../workflow_assets/module_templates/HINT/) 下，本节不重复（避免双写漂移）。
>
...
> ⚠️ **完整边界规则 + 误判案例 + 决策树** 见 `workflow_assets/module_templates/HINT/O_boundary.md`（v1.8 子模板待建）。
...
| `GUIDE_HIGHLIGHT`        | 8.新手引导高亮提示 | 遮罩/箭头/气泡/点击引导（v1.7 新增）|
| `SOCIAL_PROMPT`         | 9.聊天&社交提示   | 私聊/公会/好友/组队（v1.7 新增）|
| `OPS_PUSH_PROMPT`       | 10.运营推送类提示 | 登录福利/折扣/节日/调研（v1.7 新增）|
| `STATE_CHANGE_DIALOG`   | 11.状态变更全局提示 | 升级/升星/段位/赛季结算（v1.7 新增）|
| `COMPLIANCE_PROMPT`     | 12.风控合规提示   | 防沉迷/付费限额/实名（v1.7 新增）|
| `OFFLINE_COMPENSATION`  | 13.离线补偿&补发  | 离线奖励/维护补偿/回档补发（v1.7 新增）|
...
| ---- | ------------ | ------------------------------- | ------------------------------------------------------------------- | ---- |
| A    | 红点/角标/数字提醒 | `RED_DOT_BADGE`            | [`A_red_dot_badge.md`](../workflow_assets/module_templates/HINT/A_red_dot_badge.md)       | v1.6.1 `RED_DOT` 升级（语义扩展为"角标+数字"）|
| B    | 资源飘字     | `ITEM_FLOAT`                  | [`B_item_float.md`](../workflow_assets/module_templates/HINT/B_item_float.md)             | 资源飘字（道具/货币/积分）|
| C    | 战斗飘字     | `CURRENCY_FLOAT`              | [`C_currency_float.md`](../workflow_assets/module_templates/HINT/C_currency_float.md)     | 战斗飘字（伤害/治疗/暴击/buff），v1.7 拆分独立 |
| D    | 模态系统弹窗 | `MODAL_DIALOG`                | [`D_modal_dialog.md`](../workflow_assets/module_templates/HINT/D_modal_dialog.md)         | 错误/确认/公告/奖励汇总 |
| E    | 轻量 Toast   | `TOAST`                       | [`E_toast.md`](../workflow_assets/module_templates/HINT/E_toast.md)                       | 短时无阻断 |
| F    | 浮动通知/悬浮浮窗 | `FLOAT_NOTIFY`            | [`F_float_notify.md`](../workflow_assets/module_templates/HINT/F_float_notify.md)         | 侧边浮窗/倒计时悬浮条 |
| G    | 限时提醒+错误文案 | `TIMED_REMINDER`          | [`G_timed_reminder.md`](../workflow_assets/module_templates/HINT/G_timed_reminder.md)     | 倒计时弹窗+过期提醒+错误文案专项（v1.7+ 合并）|
| H    | 新手引导高亮提示 | `GUIDE_HIGHLIGHT`          | [`H_guide_highlight.md`](../workflow_assets/module_templates/HINT/H_guide_highlight.md)   | 遮罩/箭头/气泡/点击引导（v1.7 新增）|
| I    | 聊天&社交提示   | `SOCIAL_PROMPT`           | [`I_social_prompt.md`](../workflow_assets/module_templates/HINT/I_social_prompt.md)       | 私聊/公会/好友/组队（v1.7 新增）|
| J    | 运营推送类提示   | `OPS_PUSH_PROMPT`         | [`J_ops_push_prompt.md`](../workflow_assets/module_templates/HINT/J_ops_push_prompt.md)   | 登录福利/折扣/节日/调研（v1.7 新增）|
| K    | 状态变更全局提示 | `STATE_CHANGE_DIALOG`     | [`K_state_change_dialog.md`](../workflow_assets/module_templates/HINT/K_state_change_dialog.md) | 升级/升星/段位/赛季结算（v1.7 新增）|
| L    | 风控合规提示   | `COMPLIANCE_PROMPT`         | [`L_compliance_prompt.md`](../workflow_assets/module_templates/HINT/L_compliance_prompt.md) | 防沉迷/付费限额/实名（v1.7 新增）|
| M    | 离线补偿&补发  | `OFFLINE_COMPENSATION`     | [`M_offline_compensation.md`](../workflow_assets/module_templates/HINT/M_offline_compensation.md) | 离线奖励/维护补偿/回档补发（v1.7 新增）|
| O    | 边界区分       | —（判定规则，非测试类型）  | [`O_boundary.md`](../workflow_assets/module_templates/HINT/O_boundary.md)                 | 完整 vs UI 7 模块边界 + 8 个误判案例 + 判定流程图 |
| P    | 游戏项目补充   | —（游戏项目专项）          | [`P_game_specific.md`](../workflow_assets/module_templates/HINT/P_game_specific.md)       | 战斗/社交/运营/合规/回滚 5 类游戏专项 |
...
> **明细、场景、种子 TP、验证证据** 全部在 `workflow_assets/module_templates/LOG/` 下，本节不重复。
>
...
| ---- | ---- | ------------------- | ---- |
| A    | 玩家行为埋点采集 | `LOG_EVENT_TRACK`         | [`A_event_track.md`](../workflow_assets/module_templates/LOG/A_event_track.md) |
| B    | 资产产出消耗审计   | `LOG_ASSET_AUDIT`         | [`B_asset_audit.md`](../workflow_assets/module_templates/LOG/B_asset_audit.md) |
| C    | 全量业务操作日志   | `LOG_OPERATION`           | [`C_operation.md`](../workflow_assets/module_templates/LOG/C_operation.md) |
| D    | 服务监控埋点       | `LOG_MONITOR`             | [`D_monitor.md`](../workflow_assets/module_templates/LOG/D_monitor.md) |
| E    | 客户端崩溃/报错   | `LOG_CRASH_REPORT`        | [`E_crash_report.md`](../workflow_assets/module_templates/LOG/E_crash_report.md) |
| F    | 日志分级存储&生命周期 | `LOG_LEVEL_STORAGE`    | [`F_level_storage.md`](../workflow_assets/module_templates/LOG/F_level_storage.md) |
| G    | 日志完整性校验     | `LOG_INTEGRITY`           | [`G_integrity.md`](../workflow_assets/module_templates/LOG/G_integrity.md) |
| H    | 埋点字段合规       | `LOG_FIELD_COMPLIANCE`    | [`H_field_compliance.md`](../workflow_assets/module_templates/LOG/H_field_compliance.md) |
| I    | 线上问题溯源       | `LOG_TRACE`               | [`I_trace.md`](../workflow_assets/module_templates/LOG/I_trace.md) |
| J    | 安全&反作弊日志   | `LOG_SECURITY`            | [`J_security.md`](../workflow_assets/module_templates/LOG/J_security.md) |
| K    | 第三方关联链路     | `LOG_THIRD_PARTY`         | [`K_third_party.md`](../workflow_assets/module_templates/LOG/K_third_party.md) |
| L    | 多语言/多渠道隔离  | `LOG_ISOLATION`           | [`L_isolation.md`](../workflow_assets/module_templates/LOG/L_isolation.md) |
| M    | 日志上报容错       | `LOG_REPORT_FAULT_TOLERANT` | [`M_report_fault_tolerant.md`](../workflow_assets/module_templates/LOG/M_report_fault_tolerant.md) |
| O    | 边界区分           | —（判定规则，非测试类型）| [`O_boundary.md`](../workflow_assets/module_templates/LOG/O_boundary.md) |
| P    | 游戏项目补充       | —（游戏项目专项）| [`P_game_specific.md`](../workflow_assets/module_templates/LOG/P_game_specific.md) |
...
> ⚠️ **完整边界规则 + 误判案例 + 决策树** 见 [`LOG/O_boundary.md`](../workflow_assets/module_templates/LOG/O_boundary.md)。
...
> **新增大类说明**：v1.7 新增 6 大类（`GUIDE_HIGHLIGHT` / `SOCIAL_PROMPT` / `OPS_PUSH_PROMPT` / `STATE_CHANGE_DIALOG` / `COMPLIANCE_PROMPT` / `OFFLINE_COMPENSATION` + `TIMED_REMINDER`），全部对应原 v1.6.1 HINT 暂存版"原定义完全缺失"的 6 大类场景（用户细化补充）。
>
...
>
> **位置**：`workflow_assets/module_templates/`
>
> **维护者**：「模块定义维护人」（本角色）
...
> 完整结构规范见 `workflow_assets/module_templates/_common_structure.md`
...
> - **`workflow_assets/module_templates/`** = 明细 + 场景 + 种子 TP + 验证证据（重量）
>
...
| v1.3  | 2026-06-15 | **模块测试点模板**（S5 准入物料）落地：建立 `workflow_assets/module_templates/` 仓库 + 通用 5 段结构；UI 模块首发 10 子模板（A 控件基础 / B 纯前端交互 / C 布局适配 / D 静态展示 / E 动效 / F 引导浮窗 / G 无障碍 / H 异常场景 / I 边界区分 / J 游戏专项）+ 模块概览；新增 §10 章节；维护流程加 `[MODULES-TEMPLATE]` commit 前缀|
