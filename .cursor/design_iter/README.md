...
```bash
cat .cursor/design_iter/plans/v1/open_questions.md
```
...
# 然后编辑 .cursor/design_iter/plans/v2/PLAN.md
...
```bash
$ ls -la .cursor/design_iter/current
...
| **本目录** | `.cursor/design_iter/`（**v1 已建立**） |
| **项目根铁律** | `AGENTS.md`（v2.1 新建） |
| **v1 起点** | `.cursor/design_iter/plans/v1/PLAN.md` |
...
> **详细索引**：`cat .cursor/design_iter/INDEX.md`
