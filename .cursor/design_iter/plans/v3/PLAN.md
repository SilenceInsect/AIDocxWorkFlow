...
| # | 动作 | 验证 | 涉及文件 |
|---|---|---|---|
| 1 | 写 v3 PLAN.md（本文件） | 与 v1/v2 风格一致 | `.cursor/design_iter/plans/v3/PLAN.md` |
...
- `.cursor/design_iter/plans/v3/PLAN.md`（本文件）
- `.cursor/design_iter/plans/v3/decisions.json`
- `.cursor/design_iter/plans/v3/open_questions.md`
- `.cursor/design_iter/plans/v3/resolved_questions.md`
- `.cursor/design_iter/plans/v3/changes/diff_v2_to_v3.md`（记录 3 问机制从软到硬的演化）
...
```bash
# 整份回滚 v3
python3 .cursor/design_iter/scripts/design_iter.py rollback v2
```
...
| v3 决策记录 | `.cursor/design_iter/plans/v3/decisions.json` |
| v3 开放问题 | `.cursor/design_iter/plans/v3/open_questions.md` |
| v3→v2 diff | `.cursor/design_iter/plans/v3/changes/diff_v2_to_v3.md` |
| 触发事件 | 本文件 §0.1 |
| v1 / v2 起点 | `.cursor/design_iter/plans/{v1,v2}/PLAN.md` |
